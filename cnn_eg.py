...
# Y_data = digits.target.astype(np.float32)
# print(Y_data.shape)
# Y_data =Y_data .reshape(-1,1)#如果等于-1的话，那么Numpy会根据剩下的维度计算出数组的另外一个shape属性值。

X_data=mnist.train.images[0]
Y_data=mnist.train.labels[0].reshape(-1,1)
print (X_data.shape)
print (Y_data.shape)
